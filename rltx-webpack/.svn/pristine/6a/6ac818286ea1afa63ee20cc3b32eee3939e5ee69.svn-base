...
<script type="text/ecmascript-6">
  ...
  import { getColumn, list, getSearch, deleted, exportCsv, add, downloadErrorData, downloadTemplate } from '../../api/AccidentService';
  ...
  export default {
    ...
    data: () => {
      return {
        ...
        add,
        downloadErrorData,
        importUrl: `${ApiConst.apiMaintenaceDomain}/import/accident`,
        downloadTemplate
      };
    },
    methods: {
