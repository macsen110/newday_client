  ...
  <div id="list" class="list-page">
    <div class="list-wrap">
      <div class="page-header clearfix">
        ...
        <div class="hd-opr fr">
          <a v-if="objectName === '组织管理' && !isAdvanced" href="javascript:;" :data-link="attachmentUrl" data-title="组织管理" class="el-button el-button--primary">查看更多</a>
          <a href="javascript:;" data-link="/orgManagement/add.html" data-title="新建组织管理" class="el-button el-button--primary"><i class="el-icon-plus"></i> 新建{{ objectName }}</a>
        </div>
...
<script type="text/ecmascript-6">
  ...
  import { deleted, list, getSearch, getColumn } from '../../api/OrgManagementService';
  ...
  export default {
    ...
    data() {
      return {
        ...
        operValues: {},
        objectName: '组织管理',
        attachmentUrl: '/orgManagement/list.html',
