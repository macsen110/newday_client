...
<script type="text/ecmascript-6">
  ...
  import { getColumn, list, getSearch, exportCsv, add, downloadErrorData, downloadTemplate } from '../../api/TransportService';
  ...
  export default {
    ...
    data: () => {
      return {
        ...
        add,
        downloadErrorData,
        importUrl: `${ApiConst.apiOrgDomain}/import/transport`,
        downloadTemplate
      };
    },
    methods: {
