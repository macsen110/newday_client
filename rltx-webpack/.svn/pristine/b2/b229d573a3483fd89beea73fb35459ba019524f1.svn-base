...
<script type="text/ecmascript-6">
  ...
  import { getColumn, list, getSearch, deleted, exportCsv, add, downloadErrorData, downloadTemplate } from '../../api/AttachmentService';
  ...
  export default {
    ...
    data: () => {
      return {
        ...
        add,
        downloadErrorData,
        importUrl: `${ApiConst.apiMaintenaceDomain}/import/attachment`,
        downloadTemplate
      };
    },
    methods: {
