...
<script type="text/ecmascript-6">
  ...
  import { add, edit, get } from '../../api/TyreInspectionService';

  import ApiConst from '../../api/ApiConst';
  import { getParamsFromURL } from '../../api/Utils';

  export default {
    name: 'tyreInspectionEdit',
    components: {
      'ele-block': eleBlock,
      layout,
      logs,
    ...
    data() {
      return {
        objectName: '车轮巡检记录',
        configUrl: `${ApiConst.apiMaintenaceDomain}/detail_render_info/tyreInspection/list`,
        domainObject: {},
        addFun: add,
        editFun: edit,
        getInfo: get,
        uploadUrl: ApiConst.apiMaintenaceDomain,
        logType: 'tyre_inspection',
