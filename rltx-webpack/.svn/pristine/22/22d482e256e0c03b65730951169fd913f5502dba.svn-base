                ...
                content: [
                  {
                    ...
                    elementCode: 'text',
                    extraParams: '{"field1": "attachmentName", "placeholder1":"请输入证照名称"}'
                  },
                  {
                    showName: '车牌号',
                  ...
                  //   elementCode: 'select',
                  //   extraParams: '{"field1": "attachmentCertStatus","required": "false","placeholder1":"请选择认证状态","optionsValue1":["unauthenticated","authenticating","authenticated","failed"],"options1":["未认证","认证中","认证成功","认证失败"]}'
                  // },
                  {
                    showName: '描述',
