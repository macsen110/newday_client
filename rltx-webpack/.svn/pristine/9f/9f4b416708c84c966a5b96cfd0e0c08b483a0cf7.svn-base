...
<script type="text/ecmascript-6">
  ...
  import { add as insuranceAdd, edit as insuranceEdit, get as insuranceGet } from '../../api/InsuranceService';
  ...
  export default {
    ...
    data() {
      return {
        objectName: '保险记录',
        configUrl: `${ApiConst.apiMaintenaceDomain}/detail_render_info/insurance/list`,
        domainObject: {},
        addFun: insuranceAdd,
        editFun: insuranceEdit,
        getInfo: insuranceGet,
