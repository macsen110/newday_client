...
<script type="text/ecmascript-6">
  ...
  export default {
    name: 'singleCarSummaryList',
    components: {
      'listLayout': listLayout
    },
    data: () => {
      return {
        getColumn: ReportService.singleCarSummaryColumn,
        getList: ReportService.singleCarSummaryList,
        getSearch: ReportService.singleCarSummarySearch,
        searchModel: {},
        objectName: '单车汇总'
      };
    },
