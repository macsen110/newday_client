<template>
  <div class="custom-page form-page">
    ...
    <!--
      truckLicenseNo tyreNo inspectionDate tyreMileage deepWrinkles description
    -->
  	<!-- 1 -->
    <div class="section">
        <!-- <h2 class="tmp-title">
	    ...
	    <div class="el-row">
	    	...
	    	<div class="el-col el-col-12">
	    		<slot name="tyreNo"></slot>
	    	</div>
	    	<div class="el-col el-col-12">
	    		<slot name="inspectionDate"></slot>
	    	</div>
	    	<div class="el-col el-col-12">
	    		<slot name="tyreMileage"></slot>
	    	</div>
	    	<div class="el-col el-col-24">
	    		<slot name="deepWrinkles"></slot>
	    	</div>
