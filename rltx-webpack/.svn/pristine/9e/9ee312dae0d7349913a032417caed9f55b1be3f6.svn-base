...
<script type="text/ecmascript-6">
  export default {
    ...
    computed: {
      title() {
        if (this.isEdit) {
          return this.editable ? `编辑${this.objectName}` : `${this.objectName}详情`;
        }
        return `新建${this.objectName}`;
      }
    },
    mounted() {
