...
<script type="text/ecmascript-6">
  ...
  import { getColumn, list, getSearch, deleted, exportCsv, add, downloadErrorData, downloadTemplate } from '../../api/InsuranceService';
  ...
  export default {
    ...
    data: () => {
      return {
        ...
        add,
        downloadErrorData,
        importUrl: `${ApiConst.apiMaintenaceDomain}/import/insurance`,
        downloadTemplate
      };
    },
    methods: {
