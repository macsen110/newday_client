...
<script type="text/ecmascript-6">
  ...
  import { add, edit, get } from '../../api/TransportService';
  ...
  export default {
    ...
    data() {
      return {
        objectName: '车源',
        configUrl: `${ApiConst.apiTransportDomain}/detail_render_info/transport/list`,
        domainObject: {},
        addFun: add,
        editFun: edit,
        getInfo: get,
        uploadUrl: ApiConst.apiTransportDomain,
        logType: 'transport',
