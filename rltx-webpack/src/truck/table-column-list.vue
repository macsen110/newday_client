  ...
  <div class="tableColumn">
    ...
    <el-table-column label="操作" width="140" header-align="center">
      <template scope="scope">
        <a href="javascript:;" :data-link="'/truck/add.html?'+scope.row.code" data-title="编辑车辆" class="el-button el-button--small el-button--primary">编辑</a>
        <el-button
          size="small"
          type="default"
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    created() {
      TruckService.getColumn((success, error) => {
        if (success) {
        ...
        this.$msgbox({
          ...
          beforeClose: (action, instance, done) => {
            if (action === 'confirm') {
              ...
              TruckService.deleted(paramObj, (success, error) => {
                if (success) {
                  this.$message({
                    type: 'success',
                    message: '删除成功',
