  ...
  <div id="list" class="list-page">
    ...
    <div class="list-wrap">
      <div class="page-header clearfix">
        <h2 class="page-title fl">司机审核</h2>
            ...
            <tr v-for="list in listData" :data-error="list.error">
                ...
                <div class="cell" style="width: 100px">
                  <el-select placeholder="请选择" v-model="operValues[list.code]">
                    <el-option v-if="list.certStatus === 'authenticating'" :key="'审核'" :label="'审核'" :value="'审核'">
                      <div @click="openWindow(`${approvalUrl}?code=${list.code}`, '审核司机')">
              ...
              <td v-for="(column,index) in columnsData">
                <template v-if="column.detailLinkVisiable==='true'">
                  <a href="javascript:;" class="blue" @click="openWindow(`${approvalUrl}?code=${list.code}`, '审核司机')">
...
<script type="text/ecmascript-6">
  ...
  import { certPersonSearch, certPersonColumn, certPersonList, certPersonDisabled } from '../../../api/PlatformService';
  ...
  export default {
    ...
    data() {
      return {
        ...
        topDistance: '',
        operValues: {},
        approvalUrl: '/platform/cert_person/approval.html'
      };
    },
    methods: {
      resetScrollBar() {
      ...
      getData() {
        ...
        certPersonList(this.paramObj, (success) => {
        ...
        this.$msgbox({
          ...
          beforeClose: (action, instance, done) => {
            if (action === 'confirm') {
              ...
              certPersonDisabled(row.code, paramObj, (success, error) => {
                if (success) {
                  this.$message({
                    type: 'success',
