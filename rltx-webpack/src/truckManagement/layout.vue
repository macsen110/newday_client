<template>
  <div class="custom-page">
    <div class="page-header clearfix">
      ...
      <!-- <div class="truck-location fl" v-if="isEdit">
        车辆定位：
    ...
    <div class="section">
      ...
      <div class="el-row">
        ...
        <div class="el-col el-col-6">
          <slot name="verifyStatus"></slot>
        </div>
        <div class="el-col el-col-6">
          <slot name="operateStatus"></slot>
        </div>
        <div class="el-col el-col-6">
          <slot name="truckOwnerType"></slot>
        </div>
        <div class="el-col el-col-6">
          <slot name="truckOriginSource"></slot>
        </div>
        <div class="el-col el-col-6">
...
<script type="text/ecmascript-6">
  ...
  // import * as TruckManagementService from '../../api/TruckManagementService';
