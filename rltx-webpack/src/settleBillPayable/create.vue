    ...
    <div class="list-wrap" v-show="!tips.status">
      ...
      <div>
        ...
        <div v-if="readonly" class='tr'>
          ...
          <el-button @click="addReceiveDialog" v-if="submitData.billStatus==='accept' && submitData.receivableStatus!=='all'">添加付款</el-button>
        </div>
      </div>
      <div class="hr"></div>
      <!--收付方信息-->
...
<script>
  ...
  // 付款记录
  import ReceiveLogList from './payment_log_list.vue';
  // 审核记录
