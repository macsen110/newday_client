  ...
  <div class="tableColumn">
    ...
    <el-table-column label="操作" width="140" header-align="center">
      <template scope="scope">
        <a href="javascript:;" :data-link="'/driver/add.html?'+scope.row.code" data-title="编辑司机" class="el-button el-button--small el-button--primary">编辑</a>
        <el-button
          size="small"
          type="default"
...
<script type="text/ecmascript-6">
  import { getColumn, deleted } from '../../api/DriverService';
