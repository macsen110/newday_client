...
<script type="text/ecmascript-6">
  ...
  import { add as contractAdd, edit as contractEdit, get as contractGet } from '../../api/ContractService';
  ...
  export default {
    ...
    data() {
      return {
        objectName: '合约',
        configUrl: `${ApiConst.apiLogisticsDomain}/detail_render_info/logisticsContract/list`,
        domainObject: {},
        addFun: contractAdd,
