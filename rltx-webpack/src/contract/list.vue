...
<script type="text/ecmascript-6">
  ...
  import { getColumn, list, getSearch, deleted, exportCsv, add, downloadErrorData, downloadTemplate } from '../../api/ContractService';
  ...
  export default {
    ...
    data() {
      return {
        ...
        add,
        downloadErrorData,
        importUrl: `${ApiConst.apiLogisticsDomain}/import/logistics_contract`,
        downloadTemplate
      };
    },
    methods: {
