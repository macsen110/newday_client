...
<script type="text/ecmascript-6">
  ...
  import { getColumn, list, getSearch, deleted, exportCsv, add, downloadErrorData, downloadTemplate } from '../../api/PartnerService';
  ...
  export default {
    ...
    data: () => {
      return {
        ...
        add,
        downloadErrorData,
        importUrl: `${ApiConst.apiOrgDomain}/import/partner`,
        downloadTemplate
      };
    },
    methods: {
