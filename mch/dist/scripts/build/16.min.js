 ...
 */
 !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(3)], __WEBPACK_AMD_DEFINE_RESULT__ = (function(template){
	/**
	 **pageInitObj,
	 **页面初始化对象,
	 ...
	 ***/
	 var pageInitObj = {
		...
		ready: function (stateObj, data) {
			var self = this;
			var tplScript = __webpack_require__(61);
