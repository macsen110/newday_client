 ...
 */
!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(1), __webpack_require__(3), __webpack_require__(0)], __WEBPACK_AMD_DEFINE_RESULT__ = (function($, template, ui) {
  //init page
  var pageInitObj = {
    config: {
      wechat: {
...
module.exports = "<div class=\"page-invite\" id=\"page-invite\">\n    <img src=\"\" alt=\"\" class=\"img-code\">\n    <h3>邀请码 <span></span></h3>\n    <p>转发您的邀请码，快邀请您的朋友加入1号药城吧</p>\n</div>";
