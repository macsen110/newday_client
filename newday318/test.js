...
function() {
    return function(e) {
        ...
        window.webpackHotUpdatetcb = function(e, n) { !
            function(e, t) {
                if (!b[e] || !O[e]) return;
                for (var n in O[e] = !1, t) Object.prototype.hasOwnProperty.call(t, n) && (y[n] = t[n]);
                0 == --v && 0 === _ && S()
            } (e, n),
            t && t(e, n)
        };
        ...
        function u(e) {
            ...
            if (!t) return P;
            var r = function(r) {
                return t.hot.active ? (L[r] ? -1 === L[r].parents.indexOf(e) && L[r].parents.push(e) : (s = [e], n = r), -1 === t.children.indexOf(r) && t.children.push(r)) : (console.warn("[HMR] unexpected require(" + r + ") from disposed module " + e), s = []),
                P(r)
            },
            o = function(e) {
                return {
            ...
            for (var i in P) Object.prototype.hasOwnProperty.call(P, i) && "e" !== i && "t" !== i && Object.defineProperty(r, i, o(i));
            return r.e = function(e) {
                return "ready" === l && d("prepare"),
                _++,
                P.e(e).then(t,
                function(e) {
                    throw t(),
        ...
        function w(e) {
            ...
            return r = e,
            d("check"),
            (t = i, t = t || 1e4, new Promise(function(e, n) {
                ...
                r.onreadystatechange = function() {
                    if (4 === r.readyState) if (0 === r.status) n(new Error("Manifest request to " + i + " timed out."));
        ...
        function S() {
            d("ready");
            var e = h;
            if (h = null, e) if (r) Promise.resolve().then(function() {
                return A(r)
            }).then(function(t) {
                e.resolve(t)
            },
            function(t) {
                ...
                var t = [];
                for (var n in y) Object.prototype.hasOwnProperty.call(y, n) && t.push(E(n));
                e.resolve(t)
            }
        }
        function A(t) {
            ...
            for (var O in y) if (Object.prototype.hasOwnProperty.call(y, O)) {
                ...
                case "self-declined":
                    ...
                    t.ignoreDeclined || (T = new Error("Aborted because of self decline: " + w.moduleId + M));
                    break;
                case "declined":
                    t.onDeclined && t.onDeclined(w),
                    t.ignoreDeclined || (T = new Error("Aborted because of declined dependency: " + w.moduleId + " in " + w.parentId + M));
                    break;
                case "unaccepted":
                    t.onUnaccepted && t.onUnaccepted(w),
                    t.ignoreUnaccepted || (T = new Error("Aborted because " + u + " is not accepted" + M));
                    break;
                case "accepted":
                    t.onAccepted && t.onAccepted(w),
                    S = !0;
                    break;
                case "disposed":
                    t.onDisposed && t.onDisposed(w),
                    A = !0;
                    break;
                default:
                ...
                if (T) return d("abort"),
                Promise.reject(T);
                if (S) for (u in _[u] = y[u], p(v, w.outdatedModules), w.outdatedDependencies) Object.prototype.hasOwnProperty.call(w.outdatedDependencies, u) && (h[u] || (h[u] = []), p(h[u], w.outdatedDependencies[u]));
                A && (p(v, [w.moduleId]), _[u] = g)
            }
            var N, C = [];
            for (r = 0; r < v.length; r++) u = v[r],
            L[u] && L[u].hot._selfAccepted && C.push({
                module: u,
                errorHandler: L[u].hot._selfAccepted
            });
            d("dispose"),
            Object.keys(b).forEach(function(e) { ! 1 === b[e] &&
                function(e) {
                    delete installedChunks[e]
                } (e)
            });
            for (var I, D, R = v.slice(); R.length > 0;) if (u = R.pop(), c = L[u]) {
                var j = {},
                x = c.hot._disposeHandlers;
                for (i = 0; i < x.length; i++)(n = x[i])(j);
            ...
            for (u in h) if (Object.prototype.hasOwnProperty.call(h, u) && (c = L[u])) for (D = h[u], i = 0; i < D.length; i++) I = D[i],
            (N = c.children.indexOf(I)) >= 0 && c.children.splice(N, 1);
            for (u in d("apply"), o = m, _) Object.prototype.hasOwnProperty.call(_, u) && (e[u] = _[u]);
            var k = null;
            for (u in h) if (Object.prototype.hasOwnProperty.call(h, u) && (c = L[u])) {
                D = h[u];
                var q = [];
                for (r = 0; r < D.length; r++) if (I = D[r], n = c.hot._acceptedDependencies[I]) {
        ...
        P.t = function(e, t) {
            ...
            if (P.r(n), Object.defineProperty(n, "default", {
                enumerable: !0,
                value: e
            }), 2 & t && "string" != typeof e) for (var r in e) P.d(n, r,
            function(t) {
                return e[t]
            }.bind(null, r));
            return n
        ...
        t.SYMBOL_UNSET_FIELD_NAME = r.
    default.
        for ("UNSET_FIELD_NAME"),
        t.SYMBOL_UPDATE_COMMAND = r.
    default.
        for ("UPDATE_COMMAND"),
        t.SYMBOL_QUERY_COMMAND = r.
    default.
        for ("QUERY_COMMAND"),
        t.SYMBOL_LOGIC_COMMAND = r.
    default.
        for ("LOGIC_COMMAND"),
        t.SYMBOL_GEO_POINT = r.
    default.
        for ("GEO_POINT"),
        t.SYMBOL_GEO_LINE_STRING = r.
    default.
        for ("SYMBOL_GEO_LINE_STRING"),
        t.SYMBOL_GEO_POLYGON = r.
    default.
        for ("SYMBOL_GEO_POLYGON"),
        t.SYMBOL_GEO_MULTI_POINT = r.
    default.
        for ("SYMBOL_GEO_MULTI_POINT"),
        t.SYMBOL_GEO_MULTI_LINE_STRING = r.
    default.
        for ("SYMBOL_GEO_MULTI_LINE_STRING"),
        t.SYMBOL_GEO_MULTI_POLYGON = r.
    default.
        for ("SYMBOL_GEO_MULTI_POLYGON"),
        t.SYMBOL_SERVER_DATE = r.
    default.
        for ("SERVER_DATE"),
        t.SYMBOL_REGEXP = r.
    default.
    ...
    function(e, t, n) {
        ...
        e.exports = {
            ...
            merge: function e() {
                ...
                for (var r = 0,
                o = arguments.length; r < o; r++) u(arguments[r], n);
                return t
            },
    ...
    function(e, t, n) {
        ...
        p = function() {
            function e(e) {
                this.config = e,
                this.cache = new c.Cache(e.persistence),
                this.accessTokenKey = s.ACCESS_TOKEN + "_" + e.env,
                this.accessTokenExpireKey = s.ACCESS_TOKEN_Expire + "_" + e.env,
                this.refreshTokenKey = s.REFRESH_TOKEN + "_" + e.env
            }
            return e.prototype.refreshAccessToken = function() {
                ...
                function() {
                    ...
                    function(n) {
                        switch (n.label) {
                        case 0:
                            if (this.cache.removeStore(this.accessTokenKey), this.cache.removeStore(this.accessTokenExpireKey), !(e = this.cache.getStore(this.refreshTokenKey))) throw new Error("[tcb-js-sdk] 鏈櫥褰旵loudBase");
                            return [4, this.request("auth.getJwt", {
                                refresh_token: e
                            })];
                        case 1:
                            if ("SIGN_PARAM_INVALID" === (t = n.sent()).data.code || "REFRESH_TOKEN_EXPIRED" === t.data.code) throw u.activateEvent("LoginStateExpire"),
                            this.cache.removeStore(this.refreshTokenKey),
                            new Error("[tcb-js-sdk] 鍒锋柊access token澶辫触锛�" + t.data.code);
            ...
            e.prototype.getAccessToken = function() {
                ...
                function() {
                    ...
                    return i(this,
                    function(r) {
                        return e = this.cache.getStore(this.accessTokenKey),
                        t = this.cache.getStore(this.accessTokenExpireKey),
                        n = !0,
                        this._shouldRefreshAccessTokenHook && !this._shouldRefreshAccessTokenHook(e, t) && (n = !1),
                        (!e || !t || t < Date.now()) && n ? [2, this.refreshAccessToken()] : [2, {
                            accessToken: e,
                            accessTokenExpire: t
                        }]
                    })
            ...
            e.prototype.request = function(e, t, n) {
                ...
                function() {
                    ...
                    function(i) {
                        switch (i.label) {
                        case 0:
                            return o = "application/x-www-form-urlencoded",
                            c = r({
                                action: e,
                                env: this.config.env,
                            ...
                            t),
                            -1 !== f.indexOf(e) ? [3, 2] : (u = c, [4, this.getAccessToken()]);
                        case 1:
                            u.access_token = i.sent().accessToken,
                            i.label = 2;
                        case 2:
                            if ("storage.uploadFile" === e) {
                                for (l in p = new FormData) p.hasOwnProperty(l) && void 0 !== p[l] && p.append(l, c[l]);
                                o = "multipart/form-data"
                            } else o = "application/json;charset=UTF-8",
                            p = c;
                            return d = {
                                headers: {
                                    "content-type": o
                            ...
                            n && n.onUploadProgress && (d.onUploadProgress = n.onUploadProgress),
                            [4, a.
                        default.post(s.BASE_URL, p, d)];
                        case 3:
                ...
                function() {
                    ...
                    function(o) {
                        ...
                        case 1:
                            return r = o.sent(),
                            clearTimeout(n),
                            "ACCESS_TOKEN_EXPIRED" !== r.data.code || -1 !== f.indexOf(e) ? [3, 3] : [4, this.refreshAccessToken()];
                        case 2:
                            return o.sent(),
                            [2, this.request(e, t, {
                                onUploadProgress: t.onUploadProgress
    ...
    function(e, t, n) {
        ...
        var i = function() {
            function e(e, t, n) {
                this._internalType = o.SYMBOL_UPDATE_COMMAND,
                ...
                this.operator = e,
                this.operands = t,
                this.fieldName = n || o.SYMBOL_UNSET_FIELD_NAME
            }
        ...
        t.UpdateCommand = i,
        t.isUpdateCommand = a,
        t.isKnownUpdateCommand = function(e) {
    ...
    function(e, t, n) {
        ...
        var f = function(e) {
            function t(t, n, r) {
                ...
                return o.operator = t,
                o._internalType = s.SYMBOL_QUERY_COMMAND,
                o
            }
            return o(t, e),
            ...
            t.prototype.geoNear = function(e) {
                if (! (e.geometry instanceof c.Point)) throw new TypeError('"geometry" must be of type Point. Received type ' + typeof e.geometry);
                if (void 0 !== e.maxDistance && !u.isNumber(e.maxDistance)) throw new TypeError('"maxDistance" must be of type Number. Received type ' + typeof e.maxDistance);
                if (void 0 !== e.minDistance && !u.isNumber(e.minDistance)) throw new TypeError('"minDistance" must be of type Number. Received type ' + typeof e.minDistance);
                var n = new t(i.GEO_NEAR, [e], this.fieldName);
                return this.and(n)
            },
            t.prototype.geoWithin = function(e) {
                if (! (e.geometry instanceof c.MultiPolygon || e.geometry instanceof c.Polygon)) throw new TypeError('"geometry" must be of type Polygon or MultiPolygon. Received type ' + typeof e.geometry);
                var n = new t(i.GEO_WITHIN, [e], this.fieldName);
                return this.and(n)
            },
            t.prototype.geoIntersects = function(e) {
                if (! (e.geometry instanceof c.Point || e.geometry instanceof c.LineString || e.geometry instanceof c.Polygon || e.geometry instanceof c.MultiPoint || e.geometry instanceof c.MultiLineString || e.geometry instanceof c.MultiPolygon)) throw new TypeError('"geometry" must be of type Point, LineString, Polygon, MultiPoint, MultiLineString or MultiPolygon. Received type ' + typeof e.geometry);
        ...
        t.QueryCommand = f,
        t.isQueryCommand = p,
        t.isKnownQueryCommand = function(e) {
    ...
    function(e, t, n) {
        ...
        var a = function() {
            function e(e, t, n) {
                if (this._internalType = o.SYMBOL_LOGIC_COMMAND, Object.defineProperties(this, {
                    ...
                    for (var r = 0,
                    a = t.length; r < a; r++) {
                        var c = t[r]; (s(c) || i.isQueryCommand(c)) && (t[r] = c._setFieldName(this.fieldName))
                    }
                }
            }
            return e.prototype._setFieldName = function(t) {
            ...
            e.prototype.and = function() {
                ...
                new e(r.AND, o, this.fieldName)
            },
            e.prototype.or = function() {
                for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                var o = Array.isArray(arguments[0]) ? arguments[0] : Array.from(arguments);
                return o.unshift(this),
                new e(r.OR, o, this.fieldName)
            },
            e
        } ();
        function s(e) {
        ...
        t.LogicCommand = a,
        t.isLogicCommand = s,
        t.isKnownLogicCommand = function(e) {
    ...
    function(e, t, n) {
        ...
        t.ACCESS_TOKEN_Expire = "access_token_expire",
    ...
    function(e, t, n) {
        ...
        c = function() {
            function e(e) {
                this.config = e,
                this.Geo = r,
                this.serverDate = a.ServerDateConstructor,
                this.command = i.Command,
                this.RegExp = s.RegExpConstructor
            }
    ...
    function(e, t, n) {
        ...
        a = function() {
            function e(e, t) {
                r.Validate.isGeopoint("longitude", e),
                r.Validate.isGeopoint("latitude", t),
                this.longitude = e,
                this.latitude = t
            }
    ...
    function(e, t, n) {
        ...
        a = function() {
            ...
            e.generateDocId = function() {
                for (var e = "ABCDEFabcdef0123456789",
                t = "",
                n = 0; n < 24; n++) t += e.charAt(Math.floor(Math.random() * e.length));
                return t
            },
            e
        } ();
    ...
    function(e, t, n) {
        ...
        t.ServerDate = o,
        t.ServerDateConstructor = function(e) {
            return new o(e)
        }
    },
    function(e, t, n) {
        ...
        s = function(e) {
            function t(t, n) {
                if (n !== a) throw new TypeError("InternalSymbol cannot be constructed with new operator");
            ...
            for = function(e) {
                for (var n = 0,
                r = i.length; n < r; n++) if (i[n].target === e) return i[n].instance;
                var o = new t(e, a);
                return i.push({
                    target: e,
                    instance: o
    ...
    function(e, t, n) {
        ...
        e.exports = function(e, t, n, h, y, m, v) {
            ...
            T = !1,
            S = e.prototype,
            A = S[p] || S["@@iterator"] || y && S[y],
            L = A || b(y),
            P = y ? w ? b("entries") : L: void 0,
            M = "Array" == t && S.entries || A;
            if (M && (O = f(M.call(new e))) !== Object.prototype && O.next && (u(O, E, !0), r || "function" == typeof O[p] || a(O, p, d)), w && A && "values" !== A.name && (T = !0, L = function() {
                return A.call(this)
            }), r && !v || !l && !T && S[p] || a(S, p, L), s[t] = L, s[E] = d, y) if (_ = {
                values: w ? L: b("values"),
                keys: m ? L: b("keys"),
                entries: P
            },
            v) for (g in _) g in S || i(S, g, _[g]);
            else o(o.P + o.F * (l || T), t, _);
            return _
        }
    },
    function(e, t, n) {
        ...
        c = function(e, t, n) {
            ...
            for (u in d && (n = t), n)(f = !l && O && void 0 !== O[u]) && s(_, u) || (p = f ? O[u] : n[u], _[u] = d && "function" != typeof O[u] ? n[u] : m && f ? i(p, r) : v && O[u] == p ?
            function(e) {
    ...
    function(e, t, n) {
        ...
        c = function() {
            var e, t = n(47)("iframe"),
            r = i.length;
            for (t.style.display = "none", n(90).appendChild(t), t.src = "javascript:", (e = t.contentWindow.document).open(), e.write("<script>document.F=Object<\/script>"), e.close(), c = e.F; r--;) delete c.prototype[i[r]];
            return c()
        };
    ...
    function(e, t, n) {
        ...
        e.exports = function(e) {
            return new Promise(function(t, u) {
                ...
                l.onerror = function() {
                    u(c("Network Error", e, null, l)),
                    l = null
                },
                l.ontimeout = function() {
                    u(c("timeout of " + e.timeout + "ms exceeded", e, "ECONNABORTED", l)),
                    l = null
                },
                r.isStandardBrowserEnv()) {
                    var y = n(118),
                    m = (e.withCredentials || s(e.url)) && e.xsrfCookieName ? y.read(e.xsrfCookieName) : void 0;
                    m && (p[e.xsrfHeaderName] = m)
                }
                if ("setRequestHeader" in l && r.forEach(p,
                function(e, t) {
    ...
    function(e, t, n) {
        ...
        a = function() {
            function e(e) {
                this.httpRequest = new r.Request(e),
                this.cache = new o.Cache(e.persistence),
                this.accessTokenKey = i.ACCESS_TOKEN + "_" + e.env,
                this.accessTokenExpireKey = i.ACCESS_TOKEN_Expire + "_" + e.env,
                this.refreshTokenKey = i.REFRESH_TOKEN + "_" + e.env
            }
            ...
            e.prototype.getRefreshTokenByWXCode = function(e, t, n) {
                ...
                return this.httpRequest.send("auth.getJwt", {
                    ...
                    if (e.code) throw new Error("[tcb-js-sdk] 寰俊鐧诲綍澶辫触: " + e.code);
                    return e.refresh_token && r.cache.setStore(r.refreshTokenKey, e.refresh_token),
                    e
                })
            },
            e
    ...
    function(e, t, n) {
        ...
        function(e) {
            e.DocIDError = "鏂囨。ID涓嶅悎娉�",
            e.CollNameError = "闆嗗悎鍚嶇О涓嶅悎娉�",
            e.OpStrError = "鎿嶄綔绗︿笉鍚堟硶",
            e.DirectionError = "鎺掑簭瀛楃涓嶅悎娉�",
            e.IntergerError = "must be integer"
        } (o || (o = {})),
        t.ErrorCode = o;
        t.FieldType = {
            String: "String",
    ...
    function(e, t, n) {
        ...
        c = function() {
            ...
            e.prototype.encodeFieldUpdateCommand = function(e) {
                ...
                switch (e.operator) {
                case r.UPDATE_COMMANDS_LITERAL.REMOVE:
                    return (t = {})[s] = ((n = {})[e.fieldName] = "", n),
                    t;
                case r.UPDATE_COMMANDS_LITERAL.SET:
                case r.UPDATE_COMMANDS_LITERAL.INC:
                case r.UPDATE_COMMANDS_LITERAL.MUL:
                default:
                    return (o = {})[s] = ((i = {})[e.fieldName] = e.operands[0], i),
                    o
                }
            },
            e.prototype.encodeArrayUpdateCommand = function(e) {
                ...
                case r.UPDATE_COMMANDS_LITERAL.UNSHIFT:
                    ...
                    return (o = {})[h] = ((i = {})[e.fieldName] = y, i),
                    o;
                case r.UPDATE_COMMANDS_LITERAL.POP:
                    return (c = {})[h] = ((u = {})[e.fieldName] = 1, u),
                    c;
                case r.UPDATE_COMMANDS_LITERAL.SHIFT:
                    return (f = {})[h] = ((p = {})[e.fieldName] = -1, p),
                    f;
                default:
                    return (l = {})[h] = ((d = {})[e.fieldName] = s.encodeInternalDataType(e.operands), d),
                    l
                }
            },
    ...
    function(e, t, n) {
        ...
        o = n(21),
        i = n(19);
        for (var a in t.OperatorMap = {},
        r.QUERY_COMMANDS_LITERAL) t.OperatorMap[a] = "$" + a.toLowerCase();
        for (var a in o.LOGIC_COMMANDS_LITERAL) t.OperatorMap[a] = "$" + a.toLowerCase();
        for (var a in i.UPDATE_COMMANDS_LITERAL) t.OperatorMap[a] = "$" + a.toLowerCase();
        t.OperatorMap[r.QUERY_COMMANDS_LITERAL.NEQ] = "$ne",
        t.OperatorMap[i.UPDATE_COMMANDS_LITERAL.REMOVE] = "$unset",
        t.OperatorMap[i.UPDATE_COMMANDS_LITERAL.SHIFT] = "$pop",
        t.OperatorMap[i.UPDATE_COMMANDS_LITERAL.UNSHIFT] = "$push",
        t.operatorToString = function(e) {
    ...
    function(e, t, n) {
        ...
        function a(e, t, n, i) {
            var s = r({},
            e);
            for (var c in e) if (!/^\$/.test(c)) {
                var u = e[c];
                if (u && o.isObject(u) && !t(u)) {
                    if (i.indexOf(u) > -1) throw new Error("Cannot convert circular structure to JSON");
                    var f = a(u, t, n.concat([c]), i.concat([u]));
                    s[c] = f;
                    var p = !1;
                    for (var l in f) / ^\$ / .test(l) ? p = !0 : (s[c + "." + l] = f[l], delete s[c][l]);
                    p || delete s[c]
                }
            }
            return s
        ...
        t.isConversionRequired = s,
        t.encodeInternalDataType = function(e) {
    ...
    function(e, t, n) {
            ...
            return function e(t, n) {
                if (!i.isInternalObject(t)) {
                    ...
                    if (i.isObject(t)) {
                        ...
                        t);
                        for (var s in a) {
                            if (n.indexOf(a[s]) > -1) throw new Error("Cannot convert circular structure to JSON");
        ...
        t.deserialize = function(e) {
            ...
            case "type":
                switch (t.type) {
                case "Point":
                    if (i.isArray(t.coordinates) && i.isNumber(t.coordinates[0]) && i.isNumber(t.coordinates[1])) return new a.Point(t.coordinates[0], t.coordinates[1])
                }
            }
            return e
        }
    ...
    function(e, t, n) {
        ...
        f.prototype.database = function(e) {
            if (u.reqClass = s.Request, this.authObj) return u.getAccessToken = this.authObj.getAccessToken.bind(this.authObj),
            u.ws || (u.ws = null),
            new u(r({},
            this.config, e));
            console.warn("闇€瑕乤pp.auth()鎺堟潈")
        },
        f.prototype.auth = function(e) {
            var t = (void 0 === e ? {}: e).persistence;
            return this.authObj ? (console.warn("tcb瀹炰緥鍙瓨鍦ㄤ竴涓猘uth瀵硅薄"), this.authObj) : (Object.assign(this.config, {
                persistence: t || "session"
            }), this.authObj = new i.
        default(this.config), this.authObj)
        },
        f.prototype.on = c.addEventListener.bind(f),
        p(f.prototype, a),
        p(f.prototype, o);
        var l = new f;
        try {
    ...
    function(e, t, n) {
        ...
        t.uploadFile = function(e, t) {
            ...
            return new s.Request(this.config).send("storage.getUploadMetadata", {
                ...
                d = new FormData;
                d.append("key", n),
                d.append("signature", c),
                d.append("x-cos-meta-fileid", p),
                d.append("success_action_status", "201"),
                d.append("x-cos-security-token", u),
                d.append("file", r),
                a.
            default.post(s, d, {
                    headers: {
        ...
        t.deleteFile = function(e, t) {
            var n = e.fileList;
            if (t = t || c.createPromiseCallback(), !n || !Array.isArray(n)) return {
                code: "INVALID_PARAM",
                message: "fileList蹇呴』鏄潪绌虹殑鏁扮粍"
            };
            for (var r = 0,
            o = n; r < o.length; r++) {
                var i = o[r];
                if (!i || "string" != typeof i) return {
                    code: "INVALID_PARAM",
                    message: "fileList鐨勫厓绱犲繀椤绘槸闈炵┖鐨勫瓧绗︿覆"
                }
            }
            var a = {
                fileid_list: n
        ...
        t.getTempFileURL = function(e, t) {
            var n = e.fileList;
            t = t || c.createPromiseCallback(),
            n && Array.isArray(n) || t(null, {
                code: "INVALID_PARAM",
                message: "fileList蹇呴』鏄潪绌虹殑鏁扮粍"
            });
            for (var r = [], o = 0, a = n; o < a.length; o++) {
                var u = a[o];
                "object" === (void 0 === u ? "undefined": (0, i.
            default)(u)) ? (u.hasOwnProperty("fileID") && u.hasOwnProperty("maxAge") || t(null, {
                    code: "INVALID_PARAM",
                    message: "fileList鐨勫厓绱犲繀椤绘槸鍖呭惈fileID鍜宮axAge鐨勫璞�"
                }), r.push({
                    fileid: u.fileID,
                    max_age: u.maxAge
        ...
        t.downloadFile = function(e, n) {
            var r = e.fileID;
            return n = n || c.createPromiseCallback(),
            t.getTempFileURL.call(this, {
                fileList: [{
                    fileID: r,
                    maxAge: 600
                }]
                ...
                default.get(r, {
                        ...
                        n.href = t,
                        n.setAttribute("download", "file.pdf"),
    ...
    function(e, t, n) {
        ...
        J = function(e, t, n) {
            ...
            t = E(t, !0),
            _(n),
            o(F, t) ? (n.enumerable ? (o(e, x) && e[x][t] && (e[x][t] = !1), n = T(n, {
                enumerable: w(0, !1)
        ...
        X = function(e, t) {
            if (e = b(e), t = E(t, !0), e !== Q || !o(F, t) || o(G, t)) {
                var n = N(e, t);
                return ! n || !o(F, t) || o(e, x) && e[x][t] || (n.enumerable = !0),
                n
            }
        },
        Z = function(e) {
            for (var t, n = I(b(e)), r = [], i = 0; n.length > i;) o(F, t = n[i++]) || t == x || t == c || r.push(t);
            return r
        },
        ee = function(e) {
            for (var t, n = e === Q,
            r = I(n ? G: b(e)), i = [], a = 0; r.length > a;) ! o(F, t = r[a++]) || n && !o(Q, t) || i.push(F[t]);
            return i
        };
        B || (s((D = function() {
        ...
        for (var re = M(d.store), oe = 0; re.length > oe;) y(re[oe++]);
        a(a.S + a.F * !B, "Symbol", {
            for: function(e) {
        ...
        D.prototype[U] || n(5)(D.prototype, U, D.prototype.valueOf),
        p(D, "Symbol"),
        p(Math, "Math", !0),
        p(r.JSON, "JSON", !0)
    },
 ...
 */
    ...
    function(e, t, n) {
        ...
        u.prototype.listeners = function(e) {
            ...
            for (var r = 0,
            i = n.length,
            a = new Array(i); r < i; r++) a[r] = n[r].fn;
            return a
        },
        ...
        u.prototype.emit = function(e, t, n, r, i, a) {
            ...
            if (f.fn) {
                ...
                case 4:
                    ...
                    !0;
                case 5:
                    return f.fn.call(f.context, t, n, r, i),
                    !0;
                case 6:
                    return f.fn.call(f.context, t, n, r, i, a),
                    !0
                }
                ...
                var l, d = f.length;
                for (u = 0; u < d; u++) switch (f[u].once && this.removeListener(e, f[u].fn, void 0, !0), p) {
                case 1:
                ...
                case 4:
                    ...
                    break;
                default:
                    if (!c) for (l = 1, c = new Array(p - 1); l < p; l++) c[l - 1] = arguments[l];
        ...
        u.prototype.removeListener = function(e, t, n, r) {
            ...
            if (!t) return c(this, i),
            this;
            var a = this._events[i];
            if (a.fn) a.fn !== t || r && !a.once || n && a.context !== n || c(this, i);
            else {
                for (var s = 0,
                u = [], f = a.length; s < f; s++)(a[s].fn !== t || r && !a[s].once || n && a[s].context !== n) && u.push(a[s]);
        ...
        u.prototype.removeAllListeners = function(e) {
            var t;
            return e ? (t = o ? o + e: e, this._events[t] && c(this, t)) : (this._events = new i, this._eventsCount = 0),
            this
        },
    ...
    function(e, t, n) {
        ...
        d = function(e) {
            ...
            t.prototype.weixinAuthProvider = function(e) {
                ...
                o = e.state;
                return new c.
            default(this.config, t, n, r, o)
            },
            t.prototype.signOut = function() {
                var e = new p.Cache(this.config.persistence);
                e.removeStore(l.REFRESH_TOKEN + "_" + this.config.env),
                e.removeStore(l.ACCESS_TOKEN + "_" + this.config.env),
                e.removeStore(l.ACCESS_TOKEN_Expire + "_" + this.config.env);
            ...
            t.prototype.getAccessToken = function() {
                ...
                function() {
                    ...
                    function(t) {
                        ...
                        case 0:
                            return e = {},
                            [4, this.httpRequest.getAccessToken()];
                        case 1:
    ...
    function(e, t, n) {
        ...
        c = n(65); !
        function(e) {
            e.snsapi_base = "snsapi_base",
            e.snsapi_userinfo = "snsapi_userinfo",
            e.snsapi_login = "snsapi_login"
        } (i || (i = {})),
        function(e) {
            e.redirect = "redirect",
            e.prompt = "prompt"
        ...
        var u = function(e) {
            ...
            t.prototype.signIn = function(e) {
                ...
                if (t) {
                    if (n && n > Date.now()) return e(0),
                    e.promise;
                    this.cache.removeStore(this.accessTokenKey),
                    this.cache.removeStore(this.accessTokenExpireKey)
                }
                if (!1 === Object.values(i).includes(i[this.scope])) throw new Error("閿欒鐨剆cope绫诲瀷");
    ...
    function(e, t, n) {
        ...
        t.callFunction = function(e, t) {
            ...
            if (!n) return Promise.reject(new Error("鍑芥暟鍚嶄笉鑳戒负绌�"));
            var a = {
                function_name: n,
                request_data: i
            };
            return new r.Request(this.config).send("functions.invokeFunction", a).then(function(e) {
                if (console.log(e), e.code) t(null, e);
                    ...
                    try {
                        n = JSON.parse(e.data.response_data),
                        t(null, {
                            result: n,
                            requestId: e.requestId
                        })
    ...
    function(e, t, n) {
        ...
        a = function() {
            ...
            e.validate = function(e) {
                ...
                for (var t = 0,
                n = e.coordinates; t < n.length; t++) for (var r = 0,
                i = n[t]; r < i.length; r++) {
                    var a = i[r];
    ...
    function(e, t, n) {
        ...
        a = function() {
            ...
            e.validate = function(e) {
                ...
                for (var t = 0,
                n = e.coordinates; t < n.length; t++) for (var r = 0,
                i = n[t]; r < i.length; r++) for (var a = 0,
                s = i[r]; a < s.length; a++) {
                    var c = s[a];
                    if (!o.isNumber(c[0]) || !o.isNumber(c[1])) return ! 1
                }
                return ! 0
            },
            Object.defineProperty(e.prototype, "_internalType", {
    ...
    function(e, t, n) {
        ...
        u = function() {
            function e(e, t, n, r) {
                ...
                this._coll = t,
                this.id = n,
                this.request = new o.Db.reqClass(this._db.config),
                this.projection = r
            }
            return e.prototype.create = function(e, t) {
                ...
                return this.id && (n._id = this.id),
                this.request.send("database.addDocument", n).then(function(e) {
                    e.code ? t(0, e) : t(0, {
                        id: e.data._id,
                        requestId: e.requestId
                    })
            ...
            e.prototype.set = function(e, t) {
                ...
                var n = !1,
                o = function(e) {
                    if ("object" == typeof e) for (var t in e) e[t] instanceof c.UpdateCommand ? n = !0 : "object" == typeof e[t] && o(e[t])
                };
    ...
    function(e, t, n) {
        ...
        f = function() {
            function e(e, t, n, r, o) {
                this._db = e,
                this._coll = t,
                this._fieldFilters = n,
                this._fieldOrders = r || [],
                this._queryOptions = o || {},
                this._request = new i.Db.reqClass(this._db.config)
            }
            return e.prototype.get = function(e) {
                ...
                return this._fieldFilters && (n.query = this._fieldFilters),
                t.length > 0 && (n.order = t),
                this._queryOptions.offset && (n.offset = this._queryOptions.offset),
                this._queryOptions.limit ? n.limit = this._queryOptions.limit < 100 ? this._queryOptions.limit: 100 : n.limit = 100,
                ...
                this._request.send("database.queryDocument", n).then(function(t) {
                    if (t.code) e(0, t);
                        ...
                        t.TotalCount && (n.total = t.TotalCount),
                        t.Limit && (n.limit = t.Limit),
            ...
            e.prototype.count = function(e) {
                ...
                return this._fieldFilters && (t.query = this._fieldFilters),
                this._request.send("database.countDocument", t).then(function(t) {
                    t.code ? e(0, t) : e(0, {
                        requestId: t.requestId,
                        total: t.data.total
                    })
            ...
            e.prototype.orderBy = function(t, n) {
                a.Validate.isFieldPath(t),
                a.Validate.isFieldOrder(n);
                var r = {
                    field: t,
                    direction: n
                },
            ...
            e.prototype.limit = function(t) {
                ...
                this._queryOptions);
                return n.limit = t,
                new e(this._db, this._coll, this._fieldFilters, this._fieldOrders, n)
            },
            ...
            e.prototype.field = function(t) {
                ...
                var o = r({},
                this._queryOptions);
                return o.projection = t,
                new e(this._db, this._coll, this._fieldFilters, this._fieldOrders, o)
            },
            e.prototype.remove = function(e) {
                e = e || o.createPromiseCallback(),
                Object.keys(this._queryOptions).length > 0 && console.warn("`offset`, `limit` and `projection` are not supported in remove() operation"),
        ...
        var f = function() {
            ...
            e.prototype.encodeLogicCommand = function(e) {
                ...
                case o.LOGIC_COMMANDS_LITERAL.OR:
                    var a = s.operatorToString(e.operator),
                    c = e.operands.map(function(t) {
            ...
            e.prototype.encodeQueryCommand = function(e) {
                return r.isComparisonCommand(e),
                this.encodeComparisonCommand(e)
            },
            e.prototype.encodeComparisonCommand = function(e) {
                ...
                case r.QUERY_COMMANDS_LITERAL.GTE:
                    return (t = {})[e.fieldName] = ((n = {})[h] = c.encodeInternalDataType(e.operands[0]), n),
                    t;
                case r.QUERY_COMMANDS_LITERAL.IN:
                case r.QUERY_COMMANDS_LITERAL.NIN:
                    return (o = {})[e.fieldName] = ((a = {})[h] = c.encodeInternalDataType(e.operands), a),
                    o;
                ...
                case r.QUERY_COMMANDS_LITERAL.GEO_INTERSECTS:
                    ...
                    p;
                default:
                    return (l = {})[e.fieldName] = ((d = {})[h] = c.encodeInternalDataType(e.operands[0]), d),
                    l
                }
            },
            e.prototype.encodeQueryObject = function(e) {
                ...
                for (var n in t) {
                    ...
                    if (o.isLogicCommand(i)) {
                        ...
                        this.mergeConditionAfterEncode(t, a, n)
                    } else c.isConversionRequired(i) && (t[n] = c.encodeInternalDataType(i))
                }
                return t
            },
            e.prototype.mergeConditionAfterEncode = function(e, t, n) {
                for (var r in t[n] || delete e[n], t) e[r] ? a.isArray(e[r]) ? e[r].push(t[r]) : a.isObject(e[r]) ? a.isObject(t[r]) ? Object.assign(e, t) : (console.warn("unmergable condition, query is object but condition is " + a.getType(t) + ", can only overwrite", t, n), e[r] = t[r]) : (console.warn("to-merge query is of type " + a.getType(e) + ", can only overwrite", e, t, n), e[r] = t[r]) : e[r] = t[r]
            },
            e
        } ()
    },
    ...
    function(e, t, n) {
        ...
        t.RegExp = o,
        t.RegExpConstructor = function(e) {
            return new o(e)
        }
    }])
});