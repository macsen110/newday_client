...
/* harmony import */ var yao_m_ui__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(3);
/* harmony import */ var yao_m_ui__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(yao_m_ui__WEBPACK_IMPORTED_MODULE_2__);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var goodsUpload = function (_Component) {
    _inherits(goodsUpload, _Component);

    function goodsUpload(props) {
        _classCallCheck(this, goodsUpload);

        var _this = _possibleConstructorReturn(this, (goodsUpload.__proto__ || Object.getPrototypeOf(goodsUpload)).call(this, props));

        _this.handleSubmit = _this.handleSubmit.bind(_this);
        _this.changeSelectType = _this.changeSelectType.bind(_this);
        _this.handleUploadFiles = _this.handleUploadFiles.bind(_this);
    ...
    _createClass(goodsUpload, [{
        ...
        value: function handleSubmit(e) {
            ...
            if (!form.title.value) return Object(yao_m_ui__WEBPACK_IMPORTED_MODULE_2__["showPrompt"])('标题不能为空');
            if (!form.content.value) return Object(yao_m_ui__WEBPACK_IMPORTED_MODULE_2__["showPrompt"])('内容不能为空');
            if (type !== 'note' && this.state.uploadFiles.length === 0) return Object(yao_m_ui__WEBPACK_IMPORTED_MODULE_2__["showPrompt"])('\u8BF7\u4E0A\u4F20' + fetchDescMapType[type]);
            ...
            promise.then(function (obj) {
                if (obj.code == 0) Object(yao_m_ui__WEBPACK_IMPORTED_MODULE_2__["showPrompt"])({ msg: obj.msg, cb: function cb() {
                        return _this2.props.history.push('/goods/list');
                    } });else if (obj.code === unLoginCode) Object(yao_m_ui__WEBPACK_IMPORTED_MODULE_2__["showPrompt"])({ msg: obj.msg, cb: function cb() {
        ...
        value: function readFile(file) {
            ...
            switch (this.state.initType) {
                case 'image':
                    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('img', { src: createObjectURLfun(file) });
                case 'video':
                    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('img', { src: '/imgs/video.jpg' });
                default:
                    return '';
            }
        }
        ...
        value: function render() {
            ...
            return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
                'div',
                { id: 'app_upload_page', className: 'app-upload-page' },
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
                    'form',
                    { method: 'post', action: '/api/goods/upload', className: 'form1', onSubmit: this.handleSubmit, ref: 'goodsUplodForm' },
                    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
                        'p',
                        { className: 'pt20' },
                        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('input', { type: 'text', name: 'title', className: 'ipt', placeholder: '\u6587\u7AE0\u6807\u9898' })
                    ),
                    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
                        'div',
                        ...
                        '\u53D1\u5E03',
                        initTypeDesc,
                        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('i', { className: 'sign' }),
                        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
                            'select',
                            { name: 'category', onChange: this.changeSelectType, defaultValue: 'image' },
                            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
                                'option',
                                { value: 'image' },
                                '\u56FE\u6587'
                    ...
                    function () {
                        if (_this3.state.initType != 'note') {
                            return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
                                ...
                                '\u4E0A\u4F20',
                                initTypeDesc,
                                react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('input', { type: 'file', onChange: _this3.handleUploadFiles, multiple: 'multiple', accept: _this3.state.initType + "/*", name: 'pics', className: 'ipt', placeholder: 'file' })
                            );
                        }
                    }(),
                    function () {
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
                        'p',
                        { className: 'pt20' },
                        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('textarea', { className: 'ipt', name: 'content', placeholder: '\u6B63\u6587' })
                    ),
                    react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(
                        'p',
                        { className: 'pt20' },
                        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement('input', { type: 'submit', className: 'btn', value: '\u63D0\u4EA4\u6587\u7AE0' })
                    )
                )
            );
        }
...
//# sourceMappingURL=4.b34ea2887615c7d7af3d.js.map